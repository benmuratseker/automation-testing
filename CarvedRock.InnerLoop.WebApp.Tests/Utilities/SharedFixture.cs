...
public class SharedFixture : IAsyncLifetime
{
    ...
    public List<ProductModel> OriginalProducts { get; private set; }
    ...
    public string EmailServerUrl =>
        $"http://localhost:{_emailContainer.GetMappedPublicPort(80)}";
    ...
    private string StartWireMockForProductService()
    {
        ...
        server
            .Given(Request.Create().WithPath("/Product")
                .WithParam("category", "error").UsingGet())
    ...
    private object GetProductsBasedOnCategory(RequestMessage message)
    {
